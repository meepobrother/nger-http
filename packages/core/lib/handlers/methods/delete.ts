...
import { DeleteMetadataKey, DeleteOptions } from "../../decorator";
import { IMethodDecorator } from '@nger/decorator'
import { ROUTES } from "../../token";
import { Layer } from "../../layer";
const handler = (handler: Function, instance: any, injector: Injector, parameter: IMethodDecorator<any, DeleteOptions>) => {
